...
export const list = asyncHandler(async (req, res) => {
  const schedule = await collectionScheduleService.listSchedule(
    req.validated.query,
  );
...
export const assign = asyncHandler(async (req, res) => {
  const result = await collectionScheduleService.assignSchedule(
    req.validated.body,
    req.user.id,
  );
  res.json(result);
...
export const approve = asyncHandler(async (req, res) => {
  const result = await collectionScheduleService.approveSchedule(
